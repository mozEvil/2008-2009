...
try{ 
     String tmp = request.getParameter("fk_sel");   
     String txt = request.getParameter("fk_name"); 
     String txt2 =request.getParameter("upd_name_fk"); 
...
////////////////////////////////////////////////////////////////////////////////////
 ...
 if (txt != null){
         if(txt == ""){
             ...
             String SQL1 = "INSERT INTO fakultet(name) VALUES ('" + txt + "')";
          ...
          try{   String SQL2a = "DELETE FROM fakultet WHERE id='" + txt + "'";
                 stmt = con.createStatement();
                 rs = stmt.executeQuery(SQL2a);             
                 rs.close() ;
                 stmt.close() ; }catch(Exception e){};
                 
          try{   String SQL2b = "DELETE FROM fakultet WHERE name='" +txt+ "'";
                 stmt = con.createStatement();
          ...
          try{   String SQL3a ="UPDATE fakultet SET name='" + txt2 +"' WHERE name='" + txt + "'";
                 stmt = con.createStatement();
                 rs = stmt.executeQuery(SQL3a);             
                 rs.close() ;
                 stmt.close() ; }catch(Exception e){};
                 
          try{   String SQL3b ="UPDATE fakultet SET name='" + txt2 +"' WHERE id='" + txt + "'";
                 stmt = con.createStatement();
...
%>
<font color="#8b0000"><h2>Факультет</h2></font>
<form action="fakul.jsp" target="Main">
    <input type="text" value="" name="fk_name" />
    <select name="fk_sel">
        <option value="Add">Add</option>
        <option value="Delete">Delete</option>
        <option value="Update" onclick="newText(this.form)">Update</option>
    </select>
    <input type="submit" value="OK" name="upd_name_fk" />
</form><br>
...
<%
 ...
 //////////////////////////////////////////////////////////////////////////////////////    
   ...
   out.println("<tr bgcolor=#eebb88><th>ID: </th><th>Факультет: </th></tr>");    
   while (rs.next()) {
     out.println("<tr>");
